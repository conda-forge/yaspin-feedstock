...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaspin-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11718&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaspin-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaspin` can be installed with:

```
conda install yaspin
```

It is possible to list all of the versions of `yaspin` available on your platform with:
